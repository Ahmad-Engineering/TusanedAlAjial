...
<html lang="ar" dir="rtl">
  <head>
    ...
    @section('title-page', 'ما هو برنامج شباب تساند')
    ...
    <link rel="stylesheet" href="{{asset('tusaned/css/style.cs')}}s" />
          ...
          <div class="row pt-md-5 mt-md-2">
            <div class="col-md-5 order-1 order-md-0">
              <div class="info-about-branch text-right">
                <h2
                  ...
                  data-wow-delay=".3s"
                >
                  <span> ما هو برنامج شباب تساند الأجيال </span>
                  <span>Peer Helpers ؟</span>
                </h2>
                <h4 class="mb-4 wow fadeInDown" data-wow-delay=".4s">
                  شباب تساند الأجيال - فلسطين
                </h4>
                <p class="wow fadeInDown" data-wow-delay=".5s">
                  هو مصطلح مبني على فكرة دعم الشباب الذين غالبا ما يحتاجون
                  التحفيز و المساندة من أقرانهم عند التعرض لبعض المشاكل كالإحباط
                  أو القلق أو الشعور بالخوف. يهدف هذا المشروع إلى تمكين قدرة
                  الشباب الفلسطيني على دعم أقرانهم لمواجهة التحديات المحيطة بهم
                  كالشعور بالإحباط والمخاوف والقلق الدائم والمتواجد في المجتمعات
                  المحلية الضعيفة
                </p>
              </div>
            </div>
            <div class="col-md-7 order-0 order-md-1">
              <div class="img-about-branch mr-md-auto wow fadeInLeft">
                <img src="./image/team.png" class="img-fluid" alt="" />
              </div>
            </div>
          </div>
        </div>

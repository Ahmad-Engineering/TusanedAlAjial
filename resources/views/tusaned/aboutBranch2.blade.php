...
<html lang="ar" dir="rtl">
  <head>
    ...
    @section('title-page', 'من هم شباب تساند الأجيال')
            ...
            <div class="col-md-5 order-1 order-md-0">
              <div class="info-about-branch text-right">
                <h2
                  ...
                  data-wow-delay=".3s"
                >
                  <span>من هم شباب تساند الأجيال </span>
                  <span>Peer Helpers ؟</span>
                </h2>
                <h4 class="mb-4 wow fadeInDown" data-wow-delay=".4s">
                  المقصود بشباب تساند الأجيال
                </h4>
                <p class="wow fadeInDown" data-wow-delay=".5s">
                  هو ذلك الشاب الذي لديه القدرة و والرغبة التامّة لتقديم
                  المساعدة و الدعم للآخرين. يضم هذا المشروع برامج تدريبية مكثفة
                  تم إعدادها من قبل مجموعة من الشباب الفلسطيني لتوفير الدعم
                  اللازم لأقرانهم. ويضم هذا المشروع شبكة وطنية واسعة من الإناث
                  والذكور و الأفراد ذوي الاعاقة للمساهمة في التخفيف من حدة
                  المعاناة في المجتمعات الضعيفة. وتشمل هذه الخدمات برامج توعية،
                  وبرامج قيادة الشباب، و التدخل السريع لدعم الناجين من العنف
                  القائم على النوع الاجتماعي وبناء قدرات الشباب و في الأعمال
                  الإنسانية و المساهمات المجتمعية
                </p>
              </div>
            </div>
